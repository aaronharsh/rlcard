...
for rl_rate in 0.01 0.001 0.0001
do
    for layers in \
        64,64 \
        128,128 \
    ...
    do
        ...
        PYTHONPATH=. python examples/simple_cribbage_nfsp.py --episodes=$episodes --layers=30,30 --rl-rate=0.01 > logs/output-$now-$rl_rate-$layers
    done
done
